...
// ─── 1) Настраиваем trust proxy и rate limiter ────────────────────
...
// ─── 5) Публичные роуты с rate-limit ───────────────────────────────
app.use('/api/validate',       validateLimiter, validateRoute);
app.use('/api/validate-final', validateLimiter, validateFinalRoute);

// ─── 6) Health-check & тест БД ────────────────────────────────────
...
// ─── 7) Пресайнд URL-ы фрагментов (до аутентификации) ──────────────
...
// ─── 11) Статика для финального изображения ─────────────────────────
...
// ─── 12) Фоллбек на 404 для всех прочих файлов ──────────────────────
